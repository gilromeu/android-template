    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/gilromeu/androidtemplate/")
                ...
                scm {
                    connection.set("scm:git:git://github.com/gilromeu/androidtemplate.git")
                    developerConnection.set("scm:git:ssh://github.com/gilromeu/androidtemplate.git")
                    url.set("https://github.com/gilromeu/androidtemplate/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/gilromeu/androidtemplate/issues")
                }
            }
        }
    }
